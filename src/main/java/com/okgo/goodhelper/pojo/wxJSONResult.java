...
//    }
     ...
     */
    public static wxJSONResult formatToPojo(String jsonData, Class<?> clazz) {
        try {
            if (clazz == null) {
                return MAPPER.readValue(jsonData, wxJSONResult.class);
            }
     ...
     */
    public static wxJSONResult format(String json) {
        try {
            return MAPPER.readValue(json, wxJSONResult.class);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
     ...
     */
    public static wxJSONResult formatToList(String jsonData, Class<?> clazz) {
        try {
            JsonNode jsonNode = MAPPER.readTree(jsonData);
            JsonNode data = jsonNode.get("data");
            Object obj = null;
